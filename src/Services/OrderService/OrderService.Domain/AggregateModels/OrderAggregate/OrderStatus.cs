...
namespace OrderService.Domain.AggregateModels.OrderAggregate
{
    public class OrderStatus : Enumeration
    {
        ...
        public static OrderStatus FromName(string name)
        {
            ...
            return state ?? throw new OrderingDomainException($"Possible values for OrderStatus : {String.Join(",",List().Select(c=>c.Name))}");
        }
        public static OrderStatus Domain(int id)
        {
